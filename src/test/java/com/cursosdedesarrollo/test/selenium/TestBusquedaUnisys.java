package com.cursosdedesarrollo.test.selenium;
...
public class TestBusquedaUnisys {
  ...
  public void testBusquedaUnisys() throws Exception {
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if ("Socios".equals(driver.findElement(By.xpath("//ul[@id='zz2_RootAspMenu']/li[5]/a/span/span")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
